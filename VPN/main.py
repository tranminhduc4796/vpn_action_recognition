...
def parse_args():
    ...
    # model parameters
    parser.add_argument('--dataset', default='ntu60', type=str, choices=['ntu60', 'ntu120', 'smarthomes', 'nucla'],
    ...
    parser.add_argument('--model_name', default='vpn', type=str, choices=['vpn', 'i3d'],
                        help='Model to use for training/validation')
    parser.add_argument('--part', default='full_body', type=str, choices=['full_body', 'left_part', 'right_part'],
                        help='part of the body to use for training')
    ...
    parser.add_argument('--weights_loc', default="./checkpoint", type=str,
                        help='location to save the weights of the model')
    ...
    parser.add_argument('--protocol', default='cv', type=str,
                        help='training/validation protocol for different datasets')
    parser.add_argument('--num_nodes', default=25, type=int,
                        help='number of graph nodes to consider for a given pose data')
